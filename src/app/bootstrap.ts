...
import { bootPlugins, install as installPlugin, uninstall as uninstallPlugin } from '@/features/plugins/registry';
...
export async function bootstrap() {
  ...
  if (import.meta.env.DEV) {
    ...
    (window as unknown as { __conduit?: unknown }).__conduit = { useProjects, useSessions, useUI, useSettings, useTerminals, useNotes, useEnvironment, useTouched, useMargin, useNotifications, useArena, useAgents, useUpdate, usePlugins, seedMockWorkspace, dev: { pluginCommands, installPlugin, uninstallPlugin, applyPack, allPacks } };
  }
